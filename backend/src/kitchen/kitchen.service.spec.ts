...
describe('KitchenService', () => {
    ...
    describe('checkFefo', () => {
        ...
        it('should return matchesFefo=true if the selected batch is the oldest batch', async () => {
            const activeBatches = [
                { id: 1, batchNumber: 'BATCH001', expiryDate: new Date('2026-08-01'), quantity: 10 },
                { id: 2, batchNumber: 'BATCH002', expiryDate: new Date('2026-09-01'), quantity: 20 },
            ];
        ...
        it('should return warning details if the selected batch is not the oldest expiring batch', async () => {
            ...
            const activeBatches = [
                { id: 1, batchNumber: 'BATCH001', expiryDate: oldestDate, quantity: 10 },
            ...
            expect(result.warning).toContain('FEFO Warning: There is an older batch (#BATCH001)');
    ...
    describe('issueStock', () => {
        it('should issue stock successfully if deduction leaves no remaining unfulfilled quantity', async () => {
            const mockIssue = { id: 10, productId: 1, quantity: 5, unit: 'KG', meal: 'LUNCH', notes: 'Test issue', product: { name: 'Test Product' } };
            ...
            expect(inventoryServiceMock.deductStock).toHaveBeenCalledWith(1, 5, 'Kitchen issue - LUNCH', expect.any(Object));
        ...
        it('should throw BadRequestException if stock is insufficient', async () => {
            ...
            await expect(
                service.issueStock(issueData, 1)
