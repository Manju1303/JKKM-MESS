...
const navItems = [
  { label: 'Dashboard', href: '/dashboard', icon: LayoutDashboard, roles: ['SUPER_ADMIN', 'MESS_MANAGER', 'HOSTEL_WARDEN', 'STOREKEEPER', 'KITCHEN_STAFF', 'ACCOUNTANT', 'STUDENT', 'STUDENT_VIEWER'] },
  { label: 'Daily Menu', href: '/dashboard/menu', icon: Utensils, roles: ['SUPER_ADMIN', 'MESS_MANAGER', 'HOSTEL_WARDEN', 'STOREKEEPER', 'KITCHEN_STAFF', 'ACCOUNTANT', 'STUDENT', 'STUDENT_VIEWER'] },
  { label: 'Inventory', href: '/dashboard/inventory', icon: Boxes, roles: ['SUPER_ADMIN', 'MESS_MANAGER', 'STOREKEEPER'] },
  { label: 'Products', href: '/dashboard/products', icon: Package, roles: ['SUPER_ADMIN', 'MESS_MANAGER', 'STOREKEEPER'] },
  { label: 'Purchases', href: '/dashboard/purchases', icon: ShoppingCart, roles: ['SUPER_ADMIN', 'MESS_MANAGER', 'STOREKEEPER', 'ACCOUNTANT'] },
  { label: 'Suppliers', href: '/dashboard/suppliers', icon: Truck, roles: ['SUPER_ADMIN', 'MESS_MANAGER', 'STOREKEEPER'] },
  { label: 'Kitchen Issues', href: '/dashboard/kitchen', icon: ChefHat, roles: ['SUPER_ADMIN', 'MESS_MANAGER', 'KITCHEN_STAFF'] },
  { label: 'Barcode Scanner', href: '/dashboard/barcode', icon: QrCode, roles: ['SUPER_ADMIN', 'MESS_MANAGER', 'STOREKEEPER', 'KITCHEN_STAFF'] },
  ...
  { label: 'Notifications', href: '/dashboard/notifications', icon: Bell, roles: ['SUPER_ADMIN', 'MESS_MANAGER', 'HOSTEL_WARDEN', 'STOREKEEPER', 'KITCHEN_STAFF', 'ACCOUNTANT', 'STUDENT', 'STUDENT_VIEWER'] },
