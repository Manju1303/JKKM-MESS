...
const navItems = [
  { label: 'Dashboard', href: '/dashboard', icon: LayoutDashboard, roles: ['SUPER_ADMIN', 'MESS_MANAGER', 'HOSTEL_WARDEN', 'STOREKEEPER', 'STORE_KEEPER', 'KITCHEN_STAFF', 'ACCOUNTANT', 'STUDENT', 'STUDENT_VIEWER'] },
  { label: 'Daily Menu', href: '/dashboard/menu', icon: Utensils, roles: ['SUPER_ADMIN', 'MESS_MANAGER', 'HOSTEL_WARDEN', 'STOREKEEPER', 'STORE_KEEPER', 'KITCHEN_STAFF', 'ACCOUNTANT', 'STUDENT', 'STUDENT_VIEWER'] },
  { label: 'Inventory', href: '/dashboard/inventory', icon: Boxes, roles: ['SUPER_ADMIN', 'MESS_MANAGER', 'STOREKEEPER', 'STORE_KEEPER'] },
  { label: 'Products', href: '/dashboard/products', icon: Package, roles: ['SUPER_ADMIN', 'MESS_MANAGER', 'STOREKEEPER', 'STORE_KEEPER'] },
  { label: 'Purchases', href: '/dashboard/purchases', icon: ShoppingCart, roles: ['SUPER_ADMIN', 'MESS_MANAGER', 'STOREKEEPER', 'STORE_KEEPER', 'ACCOUNTANT'] },
  { label: 'Suppliers', href: '/dashboard/suppliers', icon: Truck, roles: ['SUPER_ADMIN', 'MESS_MANAGER', 'STOREKEEPER', 'STORE_KEEPER'] },
  { label: 'Kitchen Issues', href: '/dashboard/kitchen', icon: ChefHat, roles: ['SUPER_ADMIN', 'MESS_MANAGER', 'KITCHEN_STAFF'] },
  { label: 'Barcode Scanner', href: '/dashboard/barcode', icon: QrCode, roles: ['SUPER_ADMIN', 'MESS_MANAGER', 'STOREKEEPER', 'STORE_KEEPER', 'KITCHEN_STAFF'] },
  { label: 'Complaints', href: '/dashboard/complaints', icon: ClipboardList, roles: ['SUPER_ADMIN', 'HOSTEL_WARDEN', 'STUDENT', 'STUDENT_VIEWER'] },
  { label: 'Reports', href: '/dashboard/reports', icon: BarChart3, roles: ['SUPER_ADMIN', 'MESS_MANAGER', 'ACCOUNTANT'] },
  { label: 'Attendance', href: '/dashboard/attendance', icon: Calendar, roles: ['SUPER_ADMIN', 'HOSTEL_WARDEN'] },
  { label: 'AI Insights', href: '/dashboard/ai', icon: Brain, roles: ['SUPER_ADMIN', 'MESS_MANAGER'] },
  { label: 'Notifications', href: '/dashboard/notifications', icon: Bell, roles: ['SUPER_ADMIN', 'MESS_MANAGER', 'HOSTEL_WARDEN', 'STOREKEEPER', 'STORE_KEEPER', 'KITCHEN_STAFF', 'ACCOUNTANT', 'STUDENT', 'STUDENT_VIEWER'] },
